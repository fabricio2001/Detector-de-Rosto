 ...
 * @author fabri
 */
public class WebcamContadoDePessoa extends javax.swing.JFrame {

    /**
     * Creates new form Webcam
     */
    public WebcamContadoDePessoa() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        System.out.println("WebcamContadoDePessoa");
        ...
        if (captura.isOpened()) {
            while (true) {
                ...
                if (!video.empty()) {
                    ...
                    //System.out.println("Pessoas : " + facesDetectadas.toArray().length);
                    ...
                    if ((System.currentTimeMillis() / 1000) >= (tempoInicial / 1000) + 5) {
                        System.out.println("Pessoas encontrada a cada 5ms: " + facesDetectadas.toArray().length);
