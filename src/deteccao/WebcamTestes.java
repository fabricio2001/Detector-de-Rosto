 ...
 * @author fabri
 */
public class WebcamTestes extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        System.out.println("WebcamTestes");
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        WebcamTestes janela = new WebcamTestes();
    ...
    public void msotraVideo() {
        ...
        Mat video = new Mat();
        BackgroundSubtractorMOG2 subtracao = Video.createBackgroundSubtractorMOG2();
        ...
        if (captura.isOpened()) {
            while (true) {
                ...
                if (!video.empty()) {
                    ...
                    Mat imagemSubtacao = new Mat();
                    
                    Imgproc.cvtColor(imagemColorida, imagemCinza, Imgproc.COLOR_BGR2GRAY);
                    Imgproc.GaussianBlur(imagemCinza, imagemBlur, new Size(3, 3), 5);
                    subtracao.apply(imagemBlur, imagemSubtacao);
